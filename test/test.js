...
describe('Sequence Diagrams', function() {
    it('sequence diagram with default title', function() {
        ...
        html.should.equal('<h1>Sequence Diagrams</h1>\n<div class="visual-link-wrapper"><a href="#" data-src="https://smartdevicelink.com/media/assets/ActivateApp.png" class="visual-link"><div class="visual-link__body"><div class="t-h6 visual-link__title">Sequence Diagram</div><p class="t-default">Activate App</p></div><div class="visual-link__link fx-wrapper fx-s-between fx-a-center"><span class="fc-theme">View Diagram</span><span class="icon">{% svg "standard/icon-visual" %}</span></div></a></div>\n<img class="visual-print-image" src="https://smartdevicelink.com/media/assets/ActivateApp.png">');
    });
    ...
    it('sequence diagram with custom title', function() {
        ...
        html.should.equal('<h1>Sequence Diagrams</h1>\n<div class="visual-link-wrapper"><a href="#" data-src="https://smartdevicelink.com/media/assets/ActivateApp.png" class="visual-link"><div class="visual-link__body"><div class="t-h6 visual-link__title">Activate App Sequence Diagram</div><p class="t-default">Activate App</p></div><div class="visual-link__link fx-wrapper fx-s-between fx-a-center"><span class="fc-theme">View Diagram</span><span class="icon">{% svg "standard/icon-visual" %}</span></div></a></div>\n<img class="visual-print-image" src="https://smartdevicelink.com/media/assets/ActivateApp.png">');
    });
    ...
    it('back to back sequence diagrams', function() {
        ...
        html.should.equal('<h1>Sequence Diagrams</h1>\n<div class="visual-link-wrapper"><a href="#" data-src="https://smartdevicelink.com/media/assets/ActivateApp.png" class="visual-link"><div class="visual-link__body"><div class="t-h6 visual-link__title">Sequence Diagram</div><p class="t-default">Activate App</p></div><div class="visual-link__link fx-wrapper fx-s-between fx-a-center"><span class="fc-theme">View Diagram</span><span class="icon">{% svg "standard/icon-visual" %}</span></div></a></div>\n<img class="visual-print-image" src="https://smartdevicelink.com/media/assets/ActivateApp.png"><div class="visual-link-wrapper"><a href="#" data-src="https://smartdevicelink.com/media/assets/ActivateApp.png" class="visual-link"><div class="visual-link__body"><div class="t-h6 visual-link__title">Sequence Diagram</div><p class="t-default">Activate App</p></div><div class="visual-link__link fx-wrapper fx-s-between fx-a-center"><span class="fc-theme">View Diagram</span><span class="icon">{% svg "standard/icon-visual" %}</span></div></a></div>\n<img class="visual-print-image" src="https://smartdevicelink.com/media/assets/ActivateApp.png">');
    });
    ...
    it('sequence diagram with default title and inline styles', function() {
        ...
        html.should.equal('<h1>Sequence Diagrams</h1>\n<div class="visual-link-wrapper"><a href="#" data-src="https://smartdevicelink.com/media/assets/ActivateApp.png" class="visual-link"><div class="visual-link__body"><div class="t-h6 visual-link__title">Sequence Diagram</div><p class="t-default"><em>Activate App</em></p></div><div class="visual-link__link fx-wrapper fx-s-between fx-a-center"><span class="fc-theme">View Diagram</span><span class="icon">{% svg "standard/icon-visual" %}</span></div></a></div>\n<img class="visual-print-image" src="https://smartdevicelink.com/media/assets/ActivateApp.png">');
    });
    ...
    it('sequence diagram with default title and block styles', function() {
        ...
        html.should.equal('<h1>Sequence Diagrams</h1>\n<div class="visual-link-wrapper"><a href="#" data-src="https://smartdevicelink.com/media/assets/ActivateApp.png" class="visual-link"><div class="visual-link__body"><div class="t-h6 visual-link__title">Sequence Diagram</div><p class="t-default"><h3>Activate App</h3></p></div><div class="visual-link__link fx-wrapper fx-s-between fx-a-center"><span class="fc-theme">View Diagram</span><span class="icon">{% svg "standard/icon-visual" %}</span></div></a></div>\n<img class="visual-print-image" src="https://smartdevicelink.com/media/assets/ActivateApp.png">');
    });
});
